    ...
    companion object {
        fun start(context: Context, match: MatchDomain) {
            ...
            val inputDate = workDataOf(
                NOTIFICATION_TITLE_KEY to "O jogo vai comecar",
            ...
            WorkManager.getInstance(context)
                .enqueueUniqueWork(
                    ...
                    createRequest(initialDelay, inputDate)
                )
        }
        ...
        private fun createRequest(initialDelay: Duration, inputDate: Data): OneTimeWorkRequest =
